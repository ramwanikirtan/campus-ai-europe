    ...
    <div className="min-h-screen flex items-center justify-center px-4 hero-gradient relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">Sign in to continue your European education journey</p>
        </div>
        ...
        >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-4 text-muted-foreground/80">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-primary hover:underline hover:underline-offset-2">
                  Forgot password?
                </Link>
              </div>
              <div className="relative group">
        ...
        >
          ...
          <Link href="/auth/signup" className="text-primary hover:underline hover:underline-offset-2 font-medium">
            Sign up free
          </Link>
        </motion.p>
      </motion.div>
